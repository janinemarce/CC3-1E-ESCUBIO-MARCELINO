package rpg;
public abstract class Character implements Armor,Weapon {
    ...
    public Character(String n, int s, int d, int i){
     ...
     public abstract int  attack();//INSTUCTIONS:  Some of the implementation (such as the attack()method) can be done in many different ways and is open to your interpretation.
