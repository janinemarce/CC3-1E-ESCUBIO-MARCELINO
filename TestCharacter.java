...
/*Conditional If Statements to end the game*/
        ...
        }else if(gguk.getCurrentLife() <= 0 && gguk.getCurrentLife() < min.getCurrentLife()){ //If statement when Min Wins
            System.out.println(min.getName() + "'s Final Health: " + min.getCurrentLife());
            System.out.println(gguk.getName() + "'s Final Health: " + gguk.getCurrentLife());
            System.out.println("");
            System.out.println(min.getName() + " Wins!");
            break; //Ends the program
        }else if(min.getCurrentLife() <= 0 && min.getCurrentLife() < gguk.getCurrentLife()){ //If statement when Gguk Wins
            System.out.println(min.getName() + "'s Final Health: " + min.getCurrentLife());
            System.out.println(gguk.getName() + "'s Final Health: " + gguk.getCurrentLife()); 
            System.out.println("==============================");
